...
if __name__ == "__main__":
	...
	if sd is not None:
		...
		print("Aktueller Strom: " + str(sd.inverter.DCA))
		newA = input("Gewünschten Strom eingeben")
		sd.inverter.DCA = newA
		sd.inverter.write()
		print("Aktueller Strom: " + str(sd.inverter.DCA))

		print("Aktuelle Spannung: " + str(sd.inverter.DCV))
		newV = input("Gewünschte Spannung eingeben")
		sd.inverter.DCV = newV
		sd.inverter.write()
		print("Aktuelle Spannung: " + str(sd.inverter.DCV))
